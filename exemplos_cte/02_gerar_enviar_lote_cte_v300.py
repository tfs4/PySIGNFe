...
if __name__ == '__main__':
    ...
    resultados = mycte.processar_lote_cte(lista_cte=lista_cte, cert=info_certificado['cert'], key=info_certificado['key'], versao=u'3.00', ambiente=2, estado=u'SP', tipo_contingencia=False, salvar_arquivos=False, consultar_servico=False)
    print("\nResultado:\n")
